(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BoardHeaderComponent = /** @class */ (function () {
                function BoardHeaderComponent(boardServive) {
                    this.boardServive = boardServive;
                    this.boardname = "";
                }
                BoardHeaderComponent.prototype.ngOnInit = function () {
                    this.boardModel = new src_app_model_board_board_model__WEBPACK_IMPORTED_MODULE_3__["BoardModel"]();
                    this.boardModel.name = "";
                    this.getBoard();
                };
                BoardHeaderComponent.prototype.getBoard = function () {
                    var _this = this;
                    this.boardServive.getBoard().subscribe(function (rs) {
                        _this.boardModel = rs;
                        if (_this.boardModel.name.length == 0) {
                            _this.boardModel.name = "DEFAULT NAME";
                        }
                        _this.boardname = _this.boardModel.name;
                    });
                };
                BoardHeaderComponent.prototype.boardChange = function (name) {
                };
                BoardHeaderComponent.prototype.update = function (event) {
            ...
            BoardHeaderComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BoardComponent = /** @class */ (function () {
                function BoardComponent(listService) {
                ...
                BoardComponent.prototype.getList = function () {
                    var _this = this;
                    this.listService.getList().subscribe(function (mlists) { return _this.lists = mlists; });
                    console.log(this.lists);
                };
                BoardComponent.prototype.addList = function () {
                    var newList = new _model_list_list_model__WEBPACK_IMPORTED_MODULE_2__["List"]();
                ...
                BoardComponent.prototype.moveCardAcrossList = function (movementInformation) {
                    var _a;
                    var cardMoved = this.lists[movementInformation.fromListIdx].cards.splice(movementInformation.fromCardIdx, 1);
                    (_a = this.lists[movementInformation.toListIdx].cards).splice.apply(_a, [movementInformation.toCardIdx, 0].concat(cardMoved));
                };
                BoardComponent.prototype.saveBoard = function () {
                    var boardModel = new _model_board_board_model__WEBPACK_IMPORTED_MODULE_3__["BoardModel"]();
                    boardModel.lists = this.lists;
                };
                BoardComponent.prototype.deleteList = function (listIndex) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListComponent = /** @class */ (function () {
                function ListComponent(elementRef, document, cardService, listSerivce) {
                ...
                ListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.list.cards = [];
                    this.cardService.getCards(this.list.id).subscribe(function (rec) { return _this.list.cards = rec; });
                    this.mList = this.list;
                    this.mList.cards = [];
                };
                ListComponent.prototype.addNewCard = function () {
                    var card = new _model_card_card_model__WEBPACK_IMPORTED_MODULE_3__["Card"](this.list.id, new Date().valueOf() + "", 'header', 'summary', '', 0, "#fff", "");
                ...
                ListComponent.prototype.allowCardReplacement = function (dragEvent) {
                ...
                ListComponent.prototype.update = function (event) {
                    this.mList.name = this.list.name;
                    this.listSerivce.updateList(this.mList).subscribe();
                };
                ListComponent.prototype.dropCard = function (dragEvent) {
                    var data = JSON.parse(dragEvent.dataTransfer.getData('text'));
                    var elements = this.document.elementsFromPoint(dragEvent.x, dragEvent.y);
                    var cardElementBeingDroppedOn = elements.find(function (x) { return x.tagName.toLowerCase() === 'app-card-summary'; });
                    var listElementBeingDroppedOn = elements.find(function (x) { return x.tagName.toLowerCase() === 'app-list'; });
                    var listIndexDroppedOn = parseInt(listElementBeingDroppedOn.getAttribute('listIndex'), 10);
                    var cardIndexDroppedOn = cardElementBeingDroppedOn === undefined ? undefined :
                        parseInt(cardElementBeingDroppedOn.getAttribute('cardIndex'), 10);
                    var listIndexDragged = parseInt(data.listIndex, 10);
                    var cardIndexDragged = parseInt(data.cardIndex, 10);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SummaryComponent = /** @class */ (function () {
                function SummaryComponent(servive) {
                    this.servive = servive;
                    this.color = '#fff';
                    this.color = this.get_random_color();
                }
                SummaryComponent.prototype.get_random_color = function () {
                ...
                SummaryComponent.prototype.update = function (event) {
                    this.servive.updateCard(this.card).subscribe();
                };
                SummaryComponent.prototype.identifyCardBeingDragged = function (dragEvent) {
                ...
                SummaryComponent.prototype.allowCardDragToBeDropped = function (dragEvent) {
                    dragEvent.dataTransfer.dropEffect = 'move';
                    dragEvent.preventDefault();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContextmenuComponent = /** @class */ (function () {
                ...
                ContextmenuComponent.prototype.emitCloseEvent = function () {
                    this.contextAction.emit('DELETE');
                    this.show = false;
                };
                ContextmenuComponent.prototype.closeOutClickOutside = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var SelectProjectComponent = /** @class */ (function () {
                function SelectProjectComponent() {
                    this.boardName = "";
                ...
                SelectProjectComponent.prototype.selectOption = function (id) {
                    //getted from event
                    for (var _i = 0, _a = this.boardNames; _i < _a.length; _i++) {
                        var item = _a[_i];
                        if (item.id == id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var UseFaviconComponent = /** @class */ (function () {
                function UseFaviconComponent() {
                }
                UseFaviconComponent.prototype.ngOnInit = function () {
                };
                return UseFaviconComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ContentEditDirective = /** @class */ (function () {
                function ContentEditDirective(el, renderer2) {
                    this.el = el;
                    this.renderer2 = renderer2;
                    this.appContentEditChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                    this.ignoreChange = false;
                }
                ContentEditDirective.prototype.ngOnInit = function () {
                    this.makeContentEditable();
                };
                ContentEditDirective.prototype.exitContentEditable = function ($event) {
                    this.el.nativeElement.blur();
                    return false;
                };
                ContentEditDirective.prototype.exitContentEditableWithoutChanges = function ($event) {
                    this.ignoreChange = true;
                    this.el.nativeElement.blur();
                    return false;
                };
                ContentEditDirective.prototype.propagateChange = function () {
                ...
                ContentEditDirective.prototype.exitChange = function () {
                ...
                ContentEditDirective.prototype.makeContentEditable = function () {
                    var _this = this;
                    this.renderer2.appendChild(this.el.nativeElement, this.renderer2.createText(this.appContentEdit));
                    this.renderer2.listen(this.el.nativeElement, 'dblclick', function () {
                        _this.renderer2.setAttribute(_this.el.nativeElement, 'contenteditable', 'true');
                        _this.renderer2.addClass(_this.el.nativeElement, 'inline-edit');
                        _this.el.nativeElement.focus();
                    });
                };
                return ContentEditDirective;
            }());
            ContentEditDirective.ctorParameters = function () { return [
                { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Card = /** @class */ (function () {
                function Card(colID, id, header, summary, description, updateTime, ticketColor, asigneeTo) {
                    this.colID = colID;
                    this.id = id;
                    this.header = header;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Movement = /** @class */ (function () {
                function Movement(fromListIdx, toListIdx, fromCardIdx, toCardIdx) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var List = /** @class */ (function () {
                ...
                List.prototype.removeCard = function (id) {
                    if (this.isCardEmpty()) {
                        return null;
                    }
                    var cardIndex = this.cards.findIndex(function (x) { return x.id === id; });
                    if (cardIndex > -1) {
                        var cardInterfaces = this.cards.splice(cardIndex, 1);
                        return cardInterfaces[0];
                    }
                    return null;
                };
                List.prototype.isCardEmpty = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CardService = /** @class */ (function () {
                ...
                CardService.prototype.getCards = function (colID) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListService = /** @class */ (function () {
                ...
                ListService.prototype.addList = function (col) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' })
                    };
                ...
                ListService.prototype.removeList = function (id) {
                    var httpOptions = {
                        headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' })
                    };
